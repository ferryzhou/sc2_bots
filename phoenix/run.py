"""Run PhoenixBot locally (headless) or on the AI Arena ladder.

Local examples:
    python run.py                          # random map, Zerg CheatVision opponent
    python run.py --race terran --difficulty VeryHard --map PylonAIE
"""
...
def main():
    ...
    if config_path.is_file():
        with open(config_path) as f:
            ...
            race = Race[config.get("MyBotRace", "Protoss").title()]

    bot = Bot(race, PhoenixBot(), bot_name)
