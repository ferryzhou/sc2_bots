"""AegisBot - Terran bot built on ares-sc2.
...
class AegisBot(AresBot):
    ...
    async def on_start(self) -> None:
        await super(AegisBot, self).on_start()
    ...
    async def on_step(self, iteration: int) -> None:
        await super(AegisBot, self).on_step(iteration)
    ...
    async def on_unit_created(self, unit: Unit) -> None:
        await super(AegisBot, self).on_unit_created(unit)
